...
@Composable
fun UnderConstructionText(modifier: Modifier = Modifier) {

    val text = stringResource(R.string.under_construction)
    val startIndex = text.indexOf("Under")
    val endIndex = startIndex + "Under".length
