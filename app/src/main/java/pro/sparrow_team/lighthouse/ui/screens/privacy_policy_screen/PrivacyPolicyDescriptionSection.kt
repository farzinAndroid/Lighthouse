...
@Composable
fun PrivacyPolicyDescriptionSection(modifier: Modifier = Modifier, mainViewmodel: MainViewmodel, context: Context) {
    ...
    Column(
        ...
        Text(
            text = mainViewmodel.status.descriptions.policies ?: stringResource(R.string.privacy_policy_caption),
            style = TextStyle(
