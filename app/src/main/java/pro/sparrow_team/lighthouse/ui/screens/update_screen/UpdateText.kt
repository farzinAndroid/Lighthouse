...
@Composable
fun UpdateText(modifier: Modifier = Modifier) {

    val text = stringResource(R.string.update_to_new_version)
    val startIndex = text.indexOf("Update")
    val endIndex = startIndex + "Update".length
